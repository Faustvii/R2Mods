...
{
    public class FireGodsWand2 : ItemBase<FireGodsWand2>
    {
        ...
        public override string ItemLangTokenName => nameof(FireGodsWand2);
        public override string ItemName => "Fire Gods Wand 2";

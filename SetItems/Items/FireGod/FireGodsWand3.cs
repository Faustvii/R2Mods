...
{
    public class FireGodsWand3 : ItemBase<FireGodsWand3>
    {
        ...
        public override string ItemLangTokenName => nameof(FireGodsWand3);
        public override string ItemName => "Fire Gods Wand 3";
